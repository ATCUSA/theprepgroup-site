...
export const actions: Actions = {
  default: async ({ request, fetch }) => {
    ...
    const turnstileSecretKey = process.env.TURNSTILE_SECRET_KEY || ''; // Get secret key from environment variable
    ...
    // Submit to Formspree
    const formspreeId = process.env.PUBLIC_FORMSPREE_FORM_ID || '';
    try {
